...
public class Constantes {
    ...
    public static final String INICIAR_SESIÓN = "Iniciar sesión: ";
    public static final String SALIR = "0. Salir";
    public static final String AÑADIR_PRODUCTO = "1. Añadir producto";
    ...
    public static final String PRODUCTO_YA_EXISTENTE = "Producto ya existente";
    ...
    public static final String UNIDADES_AÑADIDAS = "Unidades añadidas";
    ...
    public static final String PRODUCTO_NO_AÑADIDO_REVISA_LOS_DATOS = "Producto no añadido revisa los datos";
    ...
    public static final String AÑADIR_CLIENTE = "8. Añadir cliente";
