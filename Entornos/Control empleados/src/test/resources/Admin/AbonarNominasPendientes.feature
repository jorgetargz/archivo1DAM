Feature: Como administrador quiero abonar las nominas pendientes para pagar a mis empleados
  ...
  Scenario: Abonar nominas pendientes
    When Abona nominas pendientes
    ...
    And Se marcan las nominas como abonadas
    #Empleado,UbicacionesTrabajadas,FechaInicio,FechaFin,ComputoDias,TiempoTrabajado,Sueldo,Abonada
    #70271249Q,{Segovia I},2022-03-16,2022-4-16,P1M,PT10H30M,105,true
    #26122403S,{Avila II},2022-03-16,2022-4-16,P1M,PT12H32M,100.08,true
    #27500613L,{Madrid I},2022-03-25,2022-4-16,P21D,PT8H30M,76.5,true
    And Se crean nuevas nominas con fecha inicio el dia posterior al dia actual a todos los empleados con franquicia asignada
    #Empleado,UbicacionesTrabajadas,FechaInicio,FechaFin,ComputoDias,TiempoTrabajado,Sueldo,Abonada
    #70271249Q,{null},2022-04-17,null,null,null,null,false
    #26122403S,{null},2022-04-17,null,null,null,null,false
    #27500613L,{null},2022-04-17,null,null,null,null,false
    And Mostrar mensaje nominas abonadas
